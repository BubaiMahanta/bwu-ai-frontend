            ...
            <div className="bg-gradient-to-tr from-gray-800 to-gray-900 p-8 rounded-2xl shadow-2xl w-full max-w-md space-y-6 border border-indigo-600/20">
                ...
                <form className="space-y-4" onSubmit={submitHandler}>
                    <div className="flex flex-col">
                        <label htmlFor="email" className="text-sm font-medium text-purple-300 mb-1">Enter your university email id</label>
                        <input
                            type="email"
                            id="email"
                            value={email}
                            ...
                            placeholder="something@brainwareuniversity.ac.in"
                        />
                    </div>
                    <button
                        type="submit"
